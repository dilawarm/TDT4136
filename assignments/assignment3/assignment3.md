# Assignment 3
## Output after running `python autograder.py -q q2`
```
...
Win Rate:      0/1 (0.00)
Record:        Loss
*** Finished running MinimaxAgent on smallClassic after 44 seconds.
...
```
## Output after running `python autograder.py -q q3`
```
autograder.py:17: DeprecationWarning: the imp module is deprecated in favour of importlib; see the module's documentation for alternative uses
  import imp
Starting on 9-22 at 16:24:25
...
Win Rate:      0/1 (0.00)
Record:        Loss
*** Finished running AlphaBetaAgent on smallClassic after 44 seconds.
*** Won 0 out of 1 games. Average score: 84.000000 ***
